...
import { View, StyleSheet, FlatList, ActivityIndicator, TouchableWithoutFeedback, WebView, Button } from 'react-native';
...
export default class TipsKehamilan extends Component {
    ...
    componentDidMount() {
        ...
        fetch(metrics.BASE_URL + '/get_kategori_tips_kehamilan.php', {
            ...
            .then((responseJson) => {
                this.setState({ isDataLoading: false, tipsList: responseJson })
            })
    }
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        <TipsItem
                            ...
                            onPress={() => navigation.navigate('tipsKehamilanKategori', { kategori: item.nama_kategori })}
                        />
                    }
                />
            )
